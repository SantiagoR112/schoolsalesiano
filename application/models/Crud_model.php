...
class Crud_model extends CI_Model { 
    ...
    function insert_periodtime(){
        ...
        $page_data = array( 
        	'profession' => $this->input->post('deadline_date')
			);
    ...
    function update_periodtime($param2){
        $page_data = array(
            'deadline_date' => $this->input->post('deadline_date')
			);

        $this->db->where('periodtime_id', $param2);
        $this->db->update('periodtime', $page_data);
    }

    function delete_periodtime($param2){
        $this->db->where('periodtime_id', $param2);
