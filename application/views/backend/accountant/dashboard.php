 ...
 <div class="row">
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Docentes');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Acudientes');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Contadores');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                ?>
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Gastos');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                $income_amount = $query->row()->amount; ?>
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Ingreso');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Administrador');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Asistencia');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0"><?php echo get_phrase('Docentes recientemente agregados');?></h3>
                    ...
                    <div class="col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0"><?php echo get_phrase('Estudiantes recientemente agregados');?></h3>
                            <div class="table-responsive">
                            <table class="table">
                                    <thead>
                                        <tr>
