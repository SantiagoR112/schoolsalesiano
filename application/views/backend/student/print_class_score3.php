...
<html>
<head>
    <title>Reporte tercer periodo</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-center">
                                        <div class="tile-stats tile-white tile-white-primary">
                                            ...
                                            <br/>
                                            <span style="font-size: 22px;">REPORTE TERCER PERIODO</span>
                                        </div>
                                        <div class="year">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                ?>
                                                <td class="<?php echo ($obtained_class_score3 >= 3) ? 'text-success' : 'text-danger'; ?>"><?php echo $obtained_class_score3; ?></td>
                                                <td><?php echo obtenerEscala($obtained_class_score3); ?></td> <!-- Llama a la función obtenerEscala() -->
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($total_subjects > 0) ? round($total_class_score3 / $total_subjects, 1) : 0; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div>
    ...
    <script>
        ...
        printButton.addEventListener('click', function() {
            ...
            html2canvas(printableArea).then(function(canvas) {
                ...
                doc.save('Reporte3periodo_<?php echo $student_id ?>.pdf');
            });
        });
    </script>
</body>
