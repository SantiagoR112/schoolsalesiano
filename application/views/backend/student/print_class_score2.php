                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo obtenerEscala($obtained_class_score2); ?></td> <!-- Llama a la función obtenerEscala() -->
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($total_subjects > 0) ? round($total_class_score2 / $total_subjects, 1) : 0; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div>
