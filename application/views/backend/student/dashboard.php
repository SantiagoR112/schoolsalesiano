 ...
 <div class="row">
                    <?php
                    // Obtiene el ID del estudiante de la sesión actual (asegúrate de tener el ID del estudiante en tu sesión)
                    $student_id = $this->session->userdata('student_id');

                    // Obtiene el class_id del estudiante desde la tabla student
                    $student_data = $this->db->get_where('student', array('student_id' => $student_id))->row();
                    $class_id = $student_data->class_id;

                    // Obtiene el número total de materiales de estudio asociados al class_id del estudiante
                    $number_of_materials = $this->db->where('class_id', $class_id)->count_all_results('material');
                    ?>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Material de Estudio');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
