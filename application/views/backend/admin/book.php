               ...
               foreach($select_book as $key => $book):
                ...
                ?>
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>admin/book/delete/<?php echo $book['book_id'];?>" onclick="return confirm('¿Estas seguro que deseas eliminar?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
