			...
			<div class="panel panel-info">
                    ...
                    <?php $select_all_request_books = $this->db->get('book_request')->result_array();
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>admin/studentRequestBook/delete/<?php echo $all_request_books_selected['book_request_id'];?>" onclick="return confirm('¿Estas seguro que deseas eliminar?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                            </td>
