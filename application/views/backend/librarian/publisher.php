				...
				<thead>
                    ...
                    foreach ($select_publisher as $key => $publisher): ?>
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>librarian/publisher/delete/<?php echo $publisher['publisher_id'];?>" onclick="return confirm('¿Estas seguro que deseas eliminar?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
